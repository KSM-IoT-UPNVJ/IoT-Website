        ...
        <div className="text-center my-6 sm:my-8 md:my-10">
          ...
          <FadeIn delay={0.3} direction={'up'}>
            <p className="text-base sm:text-lg md:text-xl max-w-5xl mx-auto px-4">
              Have a question or want to collaborate with KSM IoT UPNVJ? We'd
              love to hear from you! Reach out through the form below or connect
              with us via email or social media. Let's build the future of
              technology together.
            </p>
          </FadeIn>
        </div>
