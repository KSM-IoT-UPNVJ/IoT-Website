  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          className="relative w-[90%] h-[80%] shadow-2xl rounded-2xl p-6"
        ...
        >
          ...
          <div className="relative z-10 w-full h-full flex flex-col md:flex-row gap-8">
            {/* Bagian Kiri (Gambar) */}
            <motion.div
              className="w-full md:w-1/2 h-full bg-abu-muda rounded-lg"
            ...
            <motion.div
              className="w-full md:w-1/2 flex flex-col justify-between p-4 text-white"
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
